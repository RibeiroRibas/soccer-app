...
mixin _$PlayersViewModel on PlayersViewModelBase, Store {
  late final _$playersAlreadyGoneToReserveAtom = Atom(
      name: 'PlayersViewModelBase.playersAlreadyGoneToReserve',
      context: context);
  ...
  late final _$playersToGetInAtom =
      Atom(name: 'PlayersViewModelBase.playersToGetIn', context: context);
  ...
  late final _$playersToGetOutAtom =
      Atom(name: 'PlayersViewModelBase.playersToGetOut', context: context);
  ...
  late final _$startingPlayersAtom =
      Atom(name: 'PlayersViewModelBase.startingPlayers', context: context);
  ...
  late final _$reservePlayersAtom =
      Atom(name: 'PlayersViewModelBase.reservePlayers', context: context);
  ...
  late final _$PlayersViewModelBaseActionController =
      ActionController(name: 'PlayersViewModelBase', context: context);

  @override
  void _restartPlayersToGetIn() {
    final _$actionInfo = _$PlayersViewModelBaseActionController.startAction(
        name: 'PlayersViewModelBase._restartPlayersToGetIn');
    try {
      return super._restartPlayersToGetIn();
    } finally {
      _$PlayersViewModelBaseActionController.endAction(_$actionInfo);
    }
  }
  ...
  void _restartPlayersToGetOut() {
    final _$actionInfo = _$PlayersViewModelBaseActionController.startAction(
        name: 'PlayersViewModelBase._restartPlayersToGetOut');
    try {
  ...
  void _restartReservePlayers() {
    final _$actionInfo = _$PlayersViewModelBaseActionController.startAction(
        name: 'PlayersViewModelBase._restartReservePlayers');
    try {
  ...
  void _restartStatingPlayers() {
    final _$actionInfo = _$PlayersViewModelBaseActionController.startAction(
        name: 'PlayersViewModelBase._restartStatingPlayers');
    try {
  ...
  void _restartPlayersAlreadyGoneToReserve() {
    final _$actionInfo = _$PlayersViewModelBaseActionController.startAction(
        name: 'PlayersViewModelBase._restartPlayersAlreadyGoneToReserve');
    try {
