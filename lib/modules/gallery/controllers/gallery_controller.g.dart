...
mixin _$GalleryController on GalleryControllerBase, Store {
  late final _$currentIndexAtom =
      Atom(name: 'GalleryControllerBase.currentIndex', context: context);
  ...
  late final _$imagesAtom =
      Atom(name: 'GalleryControllerBase.images', context: context);
  ...
  late final _$videosAtom =
      Atom(name: 'GalleryControllerBase.videos', context: context);
  ...
  late final _$isMediaLocationPermanentlyDeniedAtom = Atom(
      name: 'GalleryControllerBase.isMediaLocationPermanentlyDenied',
      context: context);
  ...
  late final _$isImageAtom =
      Atom(name: 'GalleryControllerBase.isImage', context: context);
  ...
  late final _$pickImagesFromDeviceAsyncAction = AsyncAction(
      'GalleryControllerBase.pickImagesFromDevice',
      context: context);
  ...
  late final _$pickVideosFromDeviceAsyncAction = AsyncAction(
      'GalleryControllerBase.pickVideosFromDevice',
      context: context);
  ...
  void changeCurrentIndex(int index) {
    final _$actionInfo = _$GalleryControllerBaseActionController.startAction(
        name: 'GalleryControllerBase.changeCurrentIndex');
    try {
