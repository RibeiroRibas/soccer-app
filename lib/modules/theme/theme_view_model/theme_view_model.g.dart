...
mixin _$ThemeViewModel on ThemeModelBase, Store {
  late final _$currentThemeAtom =
      Atom(name: 'ThemeModelBase.currentTheme', context: context);
  ...
  late final _$isGoToSelectedThemeAtom =
      Atom(name: 'ThemeModelBase.isGoToSelectedTheme', context: context);
  ...
  late final _$onThemeChangeAtom =
      Atom(name: 'ThemeModelBase.onThemeChange', context: context);
  ...
  late final _$loadFromStorageAsyncAction =
      AsyncAction('ThemeModelBase.loadFromStorage', context: context);
  ...
  late final _$setSelectedThemeAsyncAction =
      AsyncAction('ThemeModelBase.setSelectedTheme', context: context);
